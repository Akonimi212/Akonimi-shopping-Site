...
<head>
    ...
    <title>AKONIMI Skate & Auto-mobile shop</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">AKONIMI Skate & Auto-mobile shop- Administrator Panel</a>
            </div>
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-danger">
                        ...
                        &nbsp; &nbsp; Welcome to AKONIMI Skate & Auto-mobile shop! So, if you're looking for an Element skateboard, why not visit the AKONIMI Skate & Auto-mobile shop? 
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2021 AKONIMI Skate & Auto-mobile shop| All Rights Reserved |  Design by : AKONIMI Team
