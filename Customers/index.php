...
<head>
    ...
    <title>AKONIMI AKONIMI Skate & Auto-mobile shop</title>
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">AKONIMI Skate & Auto-mobile shop</a>
            </div>
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="../assets/img/slider2.png" alt="..." style="width:100%;height:500px;">
        ...
        <div class="item">
		 ...
		 <div class="item">
            <img src="../assets/img/header.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/slider1.png" alt="..." style="width:100%;height:500px;">
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-info">
                        ...
                        &nbsp; &nbsp; Welcome to AKONIMI Skate & Auto-mobile shop! So, if you're looking for an Element skate Auto-mobile board, why not visit the AKONIMI Skateshop? 
						It's that easy. If you have a favorite skate brand, 
						this is the easiest and most straightforward way to get it. worry now!!!.
                    </div>
					<br />
			
			<div class="alert alert-default" style="background-color:#033c73;">
                       <p style="color:white;text-align:center;">
                       &copy 2021 AKONIMI Skate & Auto-mobile shop| All Rights Reserved |  Designed by : AKONIMI Team
